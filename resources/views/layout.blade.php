            ...
            <div class="containerA">
                <div class="navbar-nav navbar-expand-lg"> 
                    ...
                    @csrf 
                        ...
                        <button class="btn btn-outline-dark my-2 my-sm-0 ml-2" type="submit"><i class="fa fa-search"></i></button>
                    </form>
                </div>
                <br>
                <div class="landing-page-text" style="color: white;">
                ...
                <div class="feedback mb-4">
                    ...
                    <div class="form-floating">
                        <div class="row">
                            <div class="col-4"></div>
                            <div class="col-4">
                                <textarea class="form-control w-100 h-400" placeholder="Leave a comment here" id="comments"></textarea>
                                <div class="p-3">
                                    <button class="btn btn-outline-light my-2 my-sm-0" type="submit"><i class="fa fa-edit"></i></button>
                                </div>
                            </div>
                            <div class="col-4"></div>
                        </div>
