    ...
    <div class="col-sm-10">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="checkbox" name="cid[]" id="cid[]" value="{{$payment->id}}" onclick="cal()"><input type="hidden" name="subtotal[]" value="{{$payment->amount}}"></td> 
                    <td>{{$payment->icNo}}</td>
                    <td>{{$payment->amount}}</td>
                    <td>{{$payment->note}}</td>
                    <td>
                        <a href="{{route('delete.Record',['id'=>$payment->id]) }}" class="delete" title="Delete" data-toggle="tooltip"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true">&nbspDelete</i></button></a>
                    </td>
                </tr>
                @endforeach
                <tr align="right">
